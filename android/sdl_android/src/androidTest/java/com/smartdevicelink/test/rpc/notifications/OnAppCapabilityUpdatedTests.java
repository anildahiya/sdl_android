...
public class OnAppCapabilityUpdatedTests extends BaseRpcTests {
	...
	public void testRpcValues () {
		// Test Values
		AppCapability cmdId = ( (OnAppCapabilityUpdated) msg ).getAppCapability();

		// Valid Tests
		assertEquals(TestValues.MATCH, TestValues.GENERAL_APPCAPABILITY, cmdId);
		...
		AppCapability appCapability = msg.getAppCapability();
		assertEquals(appCapability, TestValues.GENERAL_APPCAPABILITY);
	}
}
