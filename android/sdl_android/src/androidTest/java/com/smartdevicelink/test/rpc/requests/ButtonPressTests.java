...
public class ButtonPressTests extends BaseRpcTests {
    ...
    public void testRpcValues () {
        ...
        String testModuleId = ( (ButtonPress) msg ).getModuleId();
    ...
    public void testJsonConstructor () {
        ...
        try {
            ...
            assertEquals(Test.MATCH, JsonUtils.readStringFromJsonObject(parameters, ButtonPress.KEY_MODULE_ID), cmd.getModuleId());
        }catch (JSONException e) {
            fail(Test.JSON_FAIL);
        }
    }
