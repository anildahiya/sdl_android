...
public class RadioControlDataTests extends TestCase{
    ...
    public void setUp(){
        ...
        msg.setAvailableHdChannels(Test.GENERAL_INTEGER_LIST);
    }
    ...
    public void testRpcValues () {
        ...
        assertTrue(Test.TRUE, Validator.validateIntegerList(Test.GENERAL_INTEGER_LIST, availableHdChannels));
    ...
    public void testJson(){
        ...
        try{
            ...
            reference.put(RadioControlData.KEY_AVAILABLE_HD_CHANNELS, JsonUtils.createJsonArray(Test.GENERAL_INTEGER_LIST));
            ...
            while(iterator.hasNext()){
                ...
                if(key.equals(RadioControlData.KEY_RDS_DATA)){
                    ...
                    List<Integer> availableHdChannelsListReference = JsonUtils.readIntegerListFromJsonObject(reference, key);
                    List<Integer> availableHdChannelsListTest = JsonUtils.readIntegerListFromJsonObject(underTest, key);
                    assertTrue(Test.TRUE, availableHdChannelsListReference.containsAll(availableHdChannelsListTest) && availableHdChannelsListTest.containsAll(availableHdChannelsListReference));
                } else{
