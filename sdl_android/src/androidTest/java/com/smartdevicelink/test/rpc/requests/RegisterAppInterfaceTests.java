...
public class RegisterAppInterfaceTests extends BaseRpcTests {
	...
	protected RPCMessage createMessage() {
		...
		msg.setFullAppID(Test.GENERAL_STRING);
	...
	protected JSONObject getExpectedParameters(int sdlVersion) {
		...
		try {
			...
			result.put(RegisterAppInterface.KEY_FULL_APP_ID, Test.GENERAL_STRING);
    ...
    public void testRpcValues () {    	
		...
		assertEquals(Test.MATCH, Test.GENERAL_STRING, testFullAppId);
