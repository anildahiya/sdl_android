...
public class ClimateControlCapabilities extends RPCStruct{
    ...
    public static final String KEY_CLIMATE_EANBLE_AVAILABLE = "climateEnableAvailable";
    ...
    public void setClimateEnableAvailable(Boolean climateEnableAvailable) {
        setValue(KEY_CLIMATE_EANBLE_AVAILABLE, climateEnableAvailable);
    }
    ...
    public Boolean getClimateEnableAvailable() {
        return getBoolean(KEY_CLIMATE_EANBLE_AVAILABLE);
    }
}
