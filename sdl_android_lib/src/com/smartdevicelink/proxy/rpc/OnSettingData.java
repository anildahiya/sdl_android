...
public class OnSettingData extends RPCNotification {
    ...
    public OnSettingData() {
        super(FunctionID.ON_SETTING_DATA.toString());
    }

    public OnSettingData(Hashtable<String, Object> hash) {
        super(hash);
    }
