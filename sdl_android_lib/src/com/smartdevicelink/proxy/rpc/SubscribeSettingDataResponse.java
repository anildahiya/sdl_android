...
public class SubscribeSettingDataResponse extends RPCResponse {
    ...
    public SubscribeSettingDataResponse() {
        super(FunctionID.SUBSCRIBE_SETTING_DATA.toString());
    }

    public SubscribeSettingDataResponse(Hashtable<String, Object> hash) {
        super(hash);
    }
